  ...
  return (
    <div>
      <div style={{ display: "flex", alignItems: "end", marginTop: "8px" , marginBottom:"2%" }}>
        <h2 className='header-text' style={{ marginRight: "8px", marginLeft: "2%" , flexGrow:"1"}}>قواعد العمل</h2>
        <TextField
          label="بحث"
          variant="outlined"
          size="small"
        ...
        <Table>
          <TableHead style={{ backgroundColor: "#f5f5f5" }}>
            <TableRow>
              ...
              <TableCell>قواعد العمل</TableCell>
              <TableCell>انواع قواعد العمل</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {employees
